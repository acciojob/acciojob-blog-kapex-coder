...
const blogs = [
  ...
  {
    image_url:
      "https://acciojob.com/blog/content/images/size/w2000/2023/02/Screenshot-2023-02-06-at-7.28.31-PM.png",
    image_height: "200px",
...
// Addings Blogs to DOM
blogs_map.forEach((blog) => {
  blogs_container.innerHTML += blog;
});
